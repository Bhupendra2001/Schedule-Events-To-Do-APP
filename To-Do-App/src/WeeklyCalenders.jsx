...
const WeeklyCalendars = () => {
  ...
  // const saveEvents = () => {
  //   axios
  //     .post("http://localhost:3005/api/events", events)
  ...
  const createEvent = () => {
    ...
    axios.post('http://localhost:3005/api/events', newEvent)
    .then((response) => {
  ...
  const deleteEvent = (id) => {
    axios
      .delete(`http://localhost:3005/api/events/${id}`)
      .then(() => {
  ...
  const completeEvent = (id) => {
    ...
    axios.put(`http://localhost:3005/api/events/${id}`, updatedEvents)
    .then(() => {
      setEvents(updatedEvents);
